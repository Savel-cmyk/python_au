class LeetCodeSource:
    ...
    def get_md_formatted_solution(self):
        return (self.get_md_solution_link(), '{}\n\n{}\n\n{}'.format(self.get_md_title(), self.link,
...
if __name__ == "__main__":
    main(r'C:\Users\savel\OneDrive\Рабочий стол\leetcode_tasks.txt',
         r'C:\Users\savel\PycharmProjects\python_au\leetcode\graph.md')
